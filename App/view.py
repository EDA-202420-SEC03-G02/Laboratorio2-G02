...
def print_menu():
    ...
    print("2- Cargar Tags")
    # TODO: Mods de Est-1 en el Lab 2, agregar opcion3
...
def main():
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            print("Cargando información de  los tags sobre de libros....")
            tags_libros = load_books_tags(control)
            print("Total de tags cargados: " + str(tags_libros) + "\n")
